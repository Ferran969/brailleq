...
Your Brick **Paddle OCR** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/paddle_ocr/__init__.py` and add the `@brick` decorator.
```python
# bricks/paddle_ocr/__init__.py
...
your brick is created under the `bricks/paddle_ocr` folder that contains the following files:
