...
Your Brick **Braille** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/braille/__init__.py` and add the `@brick` decorator.
```python
# bricks/braille/__init__.py
...
your brick is created under the `bricks/braille` folder that contains the following files:
